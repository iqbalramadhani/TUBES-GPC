...
void apartemen()
{
  ...
  glTranslatef(0,0,35); 
    ...
    ///belakang
    glPushMatrix();
	    glColor3ub(255, 139 ,87);
	    glScaled(4, 50,1);
	    glTranslatef(-85,2.5,-550);//geser
	    glutSolidCube(5);
    glPopMatrix();
    glPushMatrix();
	    glColor3ub(255, 139 ,87);
	    glScaled(4, 50,1);
	    glTranslatef(-75,2.5,-550);//geser
	    glutSolidCube(5);
    glPopMatrix();
    glPushMatrix();
	    glColor3ub(255, 139 ,87);
	    glScaled(4, 50,1);
	    glTranslatef(-65,2.5,-550);//geser
	    glutSolidCube(5);
    glPopMatrix();
    ...
    glPushMatrix();
	    glColor3ub(211, 211 ,211);
	    glScaled(4, 50,1);
	    glTranslatef(-85,2.5,-450);//geser
	    glutSolidCube(5);
    glPopMatrix();
    glPushMatrix();
	    glColor3ub(211, 211 ,211);
	    glScaled(4, 50,1);
	    glTranslatef(-60,2.5,-450);//geser
	    glutSolidCube(5);
    glPopMatrix();
    glPushMatrix();
	    glColor3ub(211, 211 ,211);
	    glScaled(4, 50,1);
	    glTranslatef(-35,2.5,-450);//geser
	    glutSolidCube(5);
    glPopMatrix();
    glPushMatrix();
	    glColor3ub(211, 211 ,211);
	    glScaled(4, 50,1);
	    glTranslatef(-10,2.5,-450);//geser
	    glutSolidCube(5);
    glPopMatrix();
  ...
  //  glPopMatrix();
   ...
   ////////////////////atasjendela//////////////////// 
    ...
    glPushMatrix();
	    ...
	    glScaled(12, 2,5);
	    glTranslatef(-24.2,41,-90);//geser
	    glutSolidCube(5);
    glPopMatrix();
    glPushMatrix();
	    glColor3ub(70 ,130, 180);
	    glScaled(12, 2,5);
	    glTranslatef(-24.2,81,-90);//geser
	    glutSolidCube(5);
    glPopMatrix();
    glPushMatrix();
	    glColor3ub(70, 130, 180);
	    glScaled(12, 2,5);
	    glTranslatef(-24.2,121,-90);//geser
	    glutSolidCube(5);
    glPopMatrix();
    ...
    glPushMatrix();
	    glColor3ub(70 ,130 ,180);
	    glScaled(12, 2,5);
	    glTranslatef(-15.75,41,-90);//geser
	    glutSolidCube(5);
    glPopMatrix();
    glPushMatrix();
	    glColor3ub(70 ,130 ,180);
	    glScaled(12, 2,5);
	    glTranslatef(-15.75,81,-90);//geser
	    glutSolidCube(5);
    glPopMatrix();
    glPushMatrix();
	    glColor3ub(70 ,130 ,180);
	    glScaled(12, 2,5);
	    glTranslatef(-15.75,121,-90);//geser
	    glutSolidCube(5);
    glPopMatrix();
    ...
    glPushMatrix();
	    glColor3ub(70, 130 ,180);
	    glScaled(12, 2,5);
	    glTranslatef(-7.5,41,-90);//geser
	    glutSolidCube(5);
    glPopMatrix();
    glPushMatrix();
	    glColor3ub(70 ,130 ,180);
	    glScaled(12, 2,5);
	    glTranslatef(-7.5,81,-90);//geser
	    glutSolidCube(5);
    glPopMatrix();
    glPushMatrix();
	    glColor3ub(70 ,130 ,180);
	    glScaled(12, 2,5);
	    glTranslatef(-7.5,121,-90);//geser
	    glutSolidCube(5);
    glPopMatrix();
    ...
    glPushMatrix();
	    glColor3ub(70, 130 ,180);
	    glScaled(12, 2,5);
	    glTranslatef(1,41,-90);//geser
	    glutSolidCube(5);
    glPopMatrix();
    glPushMatrix();
	    glColor3ub(70 ,130 ,180);
	    glScaled(12, 2,5);
	    glTranslatef(1,81,-90);//geser
	    glutSolidCube(5);
    glPopMatrix();
    glPushMatrix();
	    glColor3ub(70 ,130 ,180);
	    glScaled(12, 2,5);
	    glTranslatef(1.2,121,-90);//geser
	    glutSolidCube(5);
    glPopMatrix();
...
glPushMatrix();//banner
    ...
    glPushMatrix();//atapabu
	    glColor3ub(211 ,211, 211);
	    glScaled(105, 5,26);
	    glTranslatef(-1,52,-19);//geser
	    glutSolidCube(5);
    glPopMatrix();
    glPushMatrix();//ataphijau
	    glColor3ub(255 ,0, 0);
	    glScaled(105, 5,1);
	    glTranslatef(-1,52,-428);//geser
	    glutSolidCube(5);
    glPopMatrix();
    ...
    glPushMatrix();//atapkananatas
	    glColor3ub(255 ,0 ,0);
	    glScaled(50, 5,2);
	    glTranslatef(5,45,-213);//geser
	    glutSolidCube(5);
    glPopMatrix();
    glPushMatrix();//atapkananatasb
	    glColor3ub(211, 211 ,211);
	    glScaled(50, 5,27);
	    glTranslatef(5.1,45.1,-18.2);//geser
	    glutSolidCube(5);
    glPopMatrix();
    glPushMatrix();//atapkananbawah
	    glColor3ub(245, 245, 245);
	    glScaled(50, 2,20);
	    glTranslatef(4.8,45,-25);//geser
	    glutSolidCube(5);
    glPopMatrix();
    
    glPushMatrix();//design kanan gedung
	    glColor3ub(255 ,0 ,0);
	    glScaled(40, 5,24);
	    glTranslatef(5,35,-20);//geser
	    glutSolidCube(5);
    glPopMatrix();
    glPushMatrix();//design kanan gedung
	    glColor3ub(255 ,0 ,0);
	    glScaled(30, 5,24);
	    glTranslatef(5,25,-20);//geser
	    glutSolidCube(5);
    glPopMatrix();
	    ...
	    glColor3ub(0 ,100, 0);
	    glScaled(10, 4,4);
	    glTranslatef(34,4,97);//geser
	    glutSolidCube(5);
    glPopMatrix();
             glPushMatrix();//daun
	    glColor3ub(0 ,100, 0);
	    glScaled(10, 4,4);
	    glTranslatef(28,4,97);//geser
	    glutSolidCube(5);
    glPopMatrix();
    glPushMatrix();//daun
	    glColor3ub(0 ,100, 0);
	    glScaled(10, 4,4);
	    glTranslatef(22,4,97);//geser
	    glutSolidCube(5);
    glPopMatrix();
    glPushMatrix();//daun
	    glColor3ub(0 ,100, 0);
	    glScaled(10, 4,4);
	    glTranslatef(16,4,97);//geser
	    glutSolidCube(5);
    glPopMatrix();
    glPushMatrix();//daun
	    glColor3ub(0 ,100, 0);
	    glScaled(10, 4,4);
	    glTranslatef(10,4,97);//geser
	    glutSolidCube(5);
    glPopMatrix();
    glPushMatrix();//daun
	    glColor3ub(0 ,100, 0);
	    glScaled(10, 4,4);
	    glTranslatef(4,4,97);//geser
	    glutSolidCube(5);
    glPopMatrix();
    glPushMatrix();//daun
	    glColor3ub(0 ,100, 0);
	    glScaled(10, 4,4);
	    glTranslatef(-2,4,97);//geser
	    glutSolidCube(5);
    glPopMatrix();
